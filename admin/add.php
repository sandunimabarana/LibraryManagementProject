...
<div id="main">
  ...
  <form action="" class="book" method="post">
          ...
          <input type="text" name="eddition" class="form-control" placeholder="Eddition" required=""><br>
          <input type="text" name="status" class="form-control" placeholder="Status" required=""><br>
          <input type="text" name="quantity" class="form-control" placeholder="Quantity" required=""><br>
          <input type="text" name="department" class="form-control" placeholder="Department" required=""><br>

          <button class="btn btn-success" type="submit" name="submit" style="text-align:center;">ADD </button>
...
<?php
    if(isset($_POST['submit'])){
        if(isset($_SESSION['login'])){
            mysqli_query($db,"INSERT INTO books VALUES ('$_POST[bid]','$_POST[name]','$_POST[authors]','$_POST[eddition]','$_POST[status]','$_POST[quantity]','$_POST[department]');");
?>
